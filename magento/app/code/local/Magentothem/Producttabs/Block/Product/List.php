  ...
  protected function _getProductCollection()
  {
    ...
    switch ($productType) {
      case 'bestseller':
        ...
        $this->_TitleProduct = $this->__('Best Seller');
        break;
      case 'featured':
    ...
    public function getBestsellerProducts(){
        ...
        $collection = Mage::getResourceModel('producttabs/product_bestseller'); //new Magentothem_Cattabs_Model_Resource_reports_Bestseller;
