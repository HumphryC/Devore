...
$jq(document).ready(function(){
    ...
    $jq("#st_menu_link ul li").each(function(){

        var url = document.URL;

        $jq("#st_menu_link ul li a").removeClass("act");

        $jq('#st_menu_link ul li a[href="'+url+'"]').addClass('act');

    }); 

    

    $jq('.st_menu_no_child').hover(function(){
    ...
    $jq('.st_menu').hover(function(){

        if($jq(this).attr("id") != "st_menu_link"){
  ...
  jQuery('#st_custommenu .popup').hover(function() {
    jQuery(this).show();
  }, function() {
    jQuery(this).hide();
  });
